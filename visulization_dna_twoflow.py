...
class Trainer(object):
    def __init__(self, args):
        ...
        checkpoint             = torch.load('pth_result/' + args.model_dir, map_location=device)
        ...
        with torch.no_grad():
            num = 0
            for i, ( data,datareverse, labels,size) in enumerate(tbar):
                data = data.cuda()
                ...
                save_Pred_GT(pred, labels,visulization_path, val_img_ids, num, args.suffix,size)
